...
# -----------------------------
try:
    model = joblib.load("models/fraud_model_cmd.pkl")
...
# -----------------------------
# Quantum Risk Scoring (SAFE)
# -----------------------------
def quantum_risk_score(classical_risk):
    if not quantum_available:
        return classical_risk * 0.85  # fallback
...
def scan_qr(data: dict):
    ...
    parsed = parse_qs(qr_data.split("?")[1])
    ...
    result = fraud_detection(transaction)
